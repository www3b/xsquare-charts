...
> {
  ...
  /** @internal */
  readonly _renderer: Renderer | null;
  readonly renderer: 'canvas' | 'svg' | null;
  ...
  /** @internal Normalized runtime data; public consumers use `data.series`. */
  readonly _data: ChartData<TType, TData, TLabel>;
  ...
  constructor(host: HTMLElement, config: import('../../components/chart.types.js').ChartConfig);
