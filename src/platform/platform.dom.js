...
import {getRelativePosition, supportsEventListenerOptions, getMaximumSize} from '../helpers/helpers.dom.js';
...
function removeListener(chart, type, listener) {
  const target = chart && chart.renderer && chart.renderer.getEventTarget();
  if (target) {
...
function createProxyAndListen(chart, type, listener) {
  const target = chart.renderer.getEventTarget();
