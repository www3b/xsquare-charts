...
import {isArray, isFinite, isObject, valueOrDefault, resolveObjectKey, defined} from '../shared/core.js';
import {listenArrayEvents, unlistenArrayEvents} from '../shared/collection.js';
import {createContext, sign} from '../shared/index.js';
...
export default class Series {
  ...
  getDataset() {
    return this.chart._data.datasets[this.index];
  }
  ...
  draw() {
    const renderer = this.chart._renderer;
    const chart = this.chart;
    const meta = this._cachedMeta;
  ...
  _resyncElements(resetNewElements) {
    ...
    if (count) {
      ...
      // chart._data.datasets[0].data[5] = 10;
      // chart._data.datasets[0].data[5].y = 10;
      this.parse(0, count);
    }
