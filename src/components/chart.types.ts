...
export interface SeriesConfig { type?: ChartType; name?: string; data: unknown[]; backgroundColor?: string | string[] | PaintDescriptor; borderColor?: string | string[] | PaintDescriptor; borderWidth?: number; borderDash?: number[]; borderRadius?: number; borderSkipped?: boolean | string; pointRadius?: number | number[]; pointStyle?: PointStyle | PointStyle[]; pointRotation?: number | number[]; pointBackgroundColor?: string | string[] | PaintDescriptor; pointBorderColor?: string | string[] | PaintDescriptor; pointBorderWidth?: number | number[]; spanGaps?: boolean | number; tension?: number; stepped?: boolean | 'before' | 'after' | 'middle'; fill?: FillTarget | FillOptions; hidden?: boolean; stack?: string; xAxisID?: string; yAxisID?: string; rAxisID?: string; parsing?: boolean | {xAxisKey?: string; yAxisKey?: string; key?: string}; }
