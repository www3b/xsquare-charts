...
import {createContext, toFont, toPadding, _addGrace} from '../shared/options.js';
import {autoSkip} from './scale.autoskip.js';

const reverseAlign = (align) => align === 'left' ? 'right' : align === 'right' ? 'left' : align;
const offsetFromEdge = (scale, edge, offset) => edge === 'top' || edge === 'left' ? scale[edge] + offset : scale[edge] - offset;
const getTicksLimit = (ticksLength, maxTicksLimit) => Math.min(maxTicksLimit || ticksLength, ticksLength);
/**
 * @typedef { import('../shared/types/index.js').Chart } Chart
...
export default class Scale extends Element {
  ...
  /**
   * @return {import('../shared/types/index.js').LabelItem[]}
   */
  ...
  _computeLabelSizes(ticks, length, maxTicksLimit) {
    ...
    for (i = 0; i < length; i += increment) {
      ...
      if (!isNullOrUndef(label) && !isArray(label)) {
        width = measureText(this.chart._renderer, cache.data, cache.gc, width, label, fontString);
        height = lineHeight;
        ...
        for (j = 0, jlen = label.length; j < jlen; ++j) {
          ...
          if (!isNullOrUndef(nestedLabel) && !isArray(nestedLabel)) {
            width = measureText(this.chart._renderer, cache.data, cache.gc, width, nestedLabel, fontString);
            height += lineHeight;
          }
        }
      }
   ...
   */
  drawBackground() {
    this.chart._renderer.drawScale(this, 'background');
  }
  ...
  /**
	 ...
	 */
  drawGrid(chartArea) {
    this.chart._renderer.drawScale(this, 'grid', chartArea);
  }
  ...
  /**
	 ...
	 */
  drawBorder() {
    this.chart._renderer.drawScale(this, 'border');
  }
  ...
  drawLabels(chartArea) {
    this.chart._renderer.drawScale(this, 'labels', chartArea);
  }
  ...
  /**
	 ...
	 */
  drawTitle() {
    this.chart._renderer.drawScale(this, 'title');
  }
