 ...
 * @param {import('../../shared/types/index.js').CanvasFontSpec} font
 * @param {import('../../shared/types/index.js').RenderTextOpts} options
...
import {resolveSvgElementPaint} from './svg.js';
