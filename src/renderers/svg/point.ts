// @ts-nocheck
import {tracePoint} from '../canvas/text.js';
import {_isPointInArea} from '../../shared/core.js';
import {Path} from '../../geometry/path.js';
import {getOrCreateSvgDatasetPart, getOrCreateSvgElementFor, removeSvgElementFor, resolveSvgPaint, setSvgImageAttributes} from './svg.js';
